    ...
    public static void registerCommands(JDA jda) {
        ...
        try {
            jda.updateCommands()
                    ...
                    .queue(
                            success -> logger.info("Se registraron {} slash commands correctamente", success.size()),
                            error -> logger.error("Error al registrar slash commands", error)
                    );

            logger.info("Registro de slash commands iniciado (puede tardar unos minutos en propagarse)");
            
        } catch (Exception e) {
            logger.error("Error durante el registro de slash commands", e);
        }
    }
}
